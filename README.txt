Full multi-round export in original vertical order. Each -message-NN.md is one original Copy result. Each combined .md joins all copied messages with --- separators.
